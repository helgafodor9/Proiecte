...
public class DivideController implements ActionListener {
    ...
    public DivideController(JTextField polinomField1, JTextField polinomField2, JTextField result) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Polinom rezultat = Operatii.divide(polinom1, polinom2);
        //System.out.println("Rezultatul impartire: " + result.toString());
